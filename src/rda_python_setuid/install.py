...
#
#   # 3. Create a symlink so a program runs as CommonUser via pywrapper:
...
def main():
   ...
   parser.add_argument(
      '--user', required=True,
      help="User name to own the setuid binary"
   )
   ...
   if args.link:
      ...
      # chown and chmod 700: only CommonUser can execute setuid_dsarch directly.
